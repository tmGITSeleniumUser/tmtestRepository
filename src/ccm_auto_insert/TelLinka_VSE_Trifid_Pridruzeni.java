...
public class TelLinka_VSE_Trifid_Pridruzeni {

    static void proved_TelLinka_VSE_Trifid_Pridruzeni_skript(int CisloKPridruzeni, int testProstredi) {
        ...
        driver.findElement(By.xpath("/html/body/table[2]/tbody/tr/td/center/table/tbody/tr[35]/td/a")).click();  //přidružení SIM
