...
public class GSM_Postpaid_lessana {

    static void proved_GSM_Postpaid_lessana_skript(int testProstredi, String predseda){
...
//        ieCapabilities.setCapability("browserAttachTimeout",10000);
//
...
//        Thread.sleep(7000);   
        ...
        driver.findElement(By.name(HTML_identifier_library.id_aktivace_cui("i_tmprogram_id"))).sendKeys(predseda + Keys.INSERT); /*Lessana preseda*/
        ...
        driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("CHECK"))).click(); /*Lessana potvrzeni programu*/
