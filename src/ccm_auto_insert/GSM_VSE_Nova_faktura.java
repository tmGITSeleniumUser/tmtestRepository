...
public class GSM_VSE_Nova_faktura {

    static void proved_GSM_VSE_Nova_faktura_skript(int CisloKPridruzeni, int testProstredi) {
        ...
        driver.findElement(By.xpath(HTML_identifier_library.id_aktivace_cui("aktivace_gsm_nova_faktura"))).click();  // Nová faktura
