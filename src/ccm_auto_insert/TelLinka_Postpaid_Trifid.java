...
public class TelLinka_Postpaid_Trifid {

    static void proved_TelLinka_Postpaid_Trifid_skript(int testProstredi) {
        ...
        driver.findElement(By.xpath("/html/body/table[2]/tbody/tr/td/form/table/tbody/tr/td[2]/table/tbody/tr[39]/td/input[1]")).click();  //vyhledej

        WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(HTML_identifier_library.id_aktivace_cui("aktivace"))));  //aktivace
        driver.findElement(By.xpath(HTML_identifier_library.id_aktivace_cui("aktivace"))).click();

        WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/table[2]/tbody/tr/td/center/table/tbody/tr[18]/td/a")));  // aktivuj telefonní linku
        driver.findElement(By.xpath("/html/body/table[2]/tbody/tr/td/center/table/tbody/tr[18]/td/a")).click();

        WebElement element3 = wait.until(ExpectedConditions.elementToBeClickable(By.id("CON_P_COMP_LAST_NAME_FV")));   //počkej na prvek
        ...
        //driver.findElement(By.xpath("/html/body/form/table[7]/tbody/tr[80]/td[1]/input[1]")).click();  //NGOSIP checkbox

        //driver.findElement(By.id("SUB_PHONE_SAPCODE_FV")).sendKeys("000000000000070660 - VoIP brána WELL ATA172 - Stříbrná" + Keys.INSERT); //HW

        //driver.findElement(By.id("SUB_IMEI_FV")).sendKeys("000000000000000" + Keys.INSERT); //IMSI
        //driver.findElement(By.id("SCP_INSTALL_DATE_FV")).sendKeys("27.06.2015 00:00" + Keys.INSERT); // Preferované datum instalace
