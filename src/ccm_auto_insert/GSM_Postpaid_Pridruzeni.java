...
public class GSM_Postpaid_Pridruzeni {

    static void proved_GSM_Postpaid_Pridruzeni_skript(int CisloKPridruzeni, int testProstredi) {
        ...
        driver.findElement(By.xpath("/html/body/table[2]/tbody/tr/td/center/table/tbody/tr[5]/td/a")).click();  // přidružení
