...
public class TelLinka_VSE_Trifid_NovaFaktura {

    static void proved_TelLinka_VSE_Trifid_NovaFaktura_skript(int CisloKPridruzeni, int testProstredi)  {
        ...
        driver.findElement(By.xpath("/html/body/table[2]/tbody/tr/td/center/table/tbody/tr[34]/td/a")).click();  // nová faktura
