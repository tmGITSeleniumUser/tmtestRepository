...
public class TelLinka_VSE_NGOSIP_ASC {

    static void proved_TelLinka_VSE_NGOSIP_ASC_skript(int testProstredi) throws SQLException {
        ...
        driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("CON_I_FIRST_NAME_FV"))).sendKeys("Nikdo" + Keys.INSERT);             // Jméno                  
        driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("CON_I_COMP_LAST_NAME_FV"))).sendKeys("Nic" + Keys.INSERT);        // Příjmení  
        String rc;
        ...
        driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("ADR_BIL_FIRST_NAME_FV"))).sendKeys("Nikdo" + Keys.INSERT);             // Jméno    
        driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("ADR_BIL_COMP_LAST_NAME_FV"))).sendKeys("Nic" + Keys.INSERT);       // Příjmení    
        ...
        Select aktivkode = new Select(driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("SUB_QPROAT_QPROAT_ID_FV")))); // Aktivacni kod
        aktivkode.selectByVisibleText("0070 - ASC - dobírka");
