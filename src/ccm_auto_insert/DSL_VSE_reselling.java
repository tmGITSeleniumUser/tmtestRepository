...
//        driver.findElement(By.xpath("/html/body/table[2]/tbody/tr/td/center/table/tbody/tr[10]/td/a")).click(); //Aktivace DSL Pro obchodníky - Nový zákazník
        driver.findElement(By.linkText("Aktivace DSL - Nový zákazník")).click(); //Aktivace DSL - nový zákazník

//        driver.findElement(By.xpath("/html/body/table[2]/tbody/tr/td/center/table/tbody/tr[11]/td/a")).click(); //nemám hlasovou pevnou linku
        Thread.sleep(4000);
