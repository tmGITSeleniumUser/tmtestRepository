 ...
 * @author oholik
 */
public class RWE_Postpaid_aktivace {

    static void proved_RWE_Postpaid_aktivace_skript(int testProstredi, int PocetSU) {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.id("frm-orderForm-customerForm-customer-subjectType"))); // ceka na nacteni prvku
...
//        driver.findElementByXPath("/html/body/div[1]/div[5]/div[2]/div/div/div/div[2]/a[1]").click(); // Vyber konkrétního čísla
        ...
        PridejSU SU = new PridejSU();        // Přidávání více SU pod jedno CU
        SU.funkcePridejSubcribera(PocetSU);  // Volání Procedury
