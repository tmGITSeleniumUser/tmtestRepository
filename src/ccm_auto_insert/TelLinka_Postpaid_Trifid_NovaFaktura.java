...
public class TelLinka_Postpaid_Trifid_NovaFaktura {

    static void proved_TelLinka_Postpaid_Trifid_NovaFaktura_skript(int CisloKPridruzeni, int testProstredi) {
        ...
        driver.findElement(By.xpath("/html/body/table[2]/tbody/tr/td/center/table/tbody/tr[23]/td/a")).click();  // nová faktura

        //wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@type='password']")));
        //WebElement elem = driver.findElement(By.xpath("//input[@type='password']"));    //zadaní hesla
        //elem.sendKeys("2015");
...
//        driver.findElement(By.id("CON_I_COMP_LAST_NAME_FV")).sendKeys("Faktůrový" + Keys.INSERT);        // Příjmení  
