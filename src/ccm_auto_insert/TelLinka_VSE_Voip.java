...
public class TelLinka_VSE_Voip {

    static void proved_TelLinka_VSE_Voip_skript(int testProstredi, int pocetPocetZakazniku, boolean auto_finished) throws SQLException {
...
//            driver.findElement(By.name(HTML_identifier_library.id_aktivace_cui("i_solus"))).click();
            ...
            droplistTS.selectByVisibleText("Fyzická osoba - podnikatel");
            ...
            WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(HTML_identifier_library.id_aktivace_cui("fix"))));
            driver.findElement(By.xpath(HTML_identifier_library.id_aktivace_cui("fix"))).click();

//            WebElement zobrazeni_zadosti = (new WebDriverWait(driver, 20)) /*čekání na prvek*/
//                    .until(ExpectedConditions.presenceOfElementLocated(By.name(HTML_identifier_library.id_aktivace_cui("i_val"))));
...
//            driver.findElement(By.name(HTML_identifier_library.id_aktivace_cui("i_val"))).click();
            ...
            String rc;
            driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("CON_I_BIRTH_NUMBER_FV"))).sendKeys(rc = VerifiedRCDdatabase(dbConnection.dbConnection_dwh(testProstredi), testProstredi) + "" + Keys.INSERT);    // Rodné číslo
            ...
            Select droplistTarif = new Select(driver.findElement(By.id("SUB_QPROTAR_QPROTAR_ID_FV")));                  // vybrání ICCID karty
            droplistTarif.selectByVisibleText("Hlasová linka Premium HIT");
            ...
            driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("SUB_ICCID_FV"))).sendKeys(SQL_selects.ICCIDVoip(dbConnection.dbConnection_qap(testProstredi),testProstredi) + "" + Keys.INSERT);
            ...
            driver.findElement(By.id(HTML_identifier_library.id_aktivace_cui("but4"))).click(); /* Založka služby*/


            /*Toto řeší uložení MSISDN do souboru*/
            System.out.println(driver.findElement(By.id("SUB_MSISDN_FV_RO")).getAttribute("value"));
            System.out.println(driver.findElement(By.xpath("/html/body/form/center/h3/a")));
            
            OutputInputFile.writeMSISDNVoipNG(driver.findElement(By.id("SUB_MSISDN_FV_RO")).getAttribute("value"), SQL_selects.ExtCUID(dbConnection.dbConnection_qap(testProstredi), testProstredi, driver.findElement(By.xpath("/html/body/form/center/h3/a")).getText()));
